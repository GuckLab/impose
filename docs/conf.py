#
# impose documentation build configuration file, created by
...
rst_prolog = """
:github_url: https://github.com/GuckLab/impose
"""
...
html_logo = "logo/impose_large_white.svg"
html_theme_options = {
    'logo_only': True,
}
...
latex_documents = [
    (master_doc, 'impose.tex', 'impose Documentation',
     author.replace(', ', '\\and '),
     'manual'),
]
